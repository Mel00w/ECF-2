    ...
    <main class="container mt-4">
        <article>
            ...
            <div class="d-flex align-items-center" >
                <img class="mr-1" src="<?= htmlspecialchars($article['profile_picture']) ?>" alt="Profile Picture" style="width: 50px; height: 50px; border-radius: 50%;">
                <h2 class="poppins-regular profile-pic-name me-2"><?= htmlspecialchars($article['username']) ?></h2>
                <p class="fst-italic" >Publié le : <?= htmlspecialchars($article['date_published']) ?></p>
            </div>
